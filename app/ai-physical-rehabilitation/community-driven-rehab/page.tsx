      ...
      <main className="flex-1">
        ...
        <section className="py-12">
          <div className="container mx-auto px-6 max-w-3xl prose prose-lg dark:prose-invert space-y-8">
            ...
            <ul>
              <li><a href="/ai-physical-rehabilitation/what-is-ai-physical-rehabilitation">What is AI in Physical Rehabilitation?</a></li>
              <li><a href="/ai-physical-rehabilitation/personalized-rehab-plans">How AI Personalizes Rehab Plans</a></li>
