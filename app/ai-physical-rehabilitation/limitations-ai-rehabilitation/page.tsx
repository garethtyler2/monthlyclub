      ...
      <main className="flex-1">
        ...
        <section className="py-12">
          <div className="container mx-auto px-6 max-w-3xl prose prose-lg dark:prose-invert space-y-8">
            ...
            <ul>
              <li><a href="/ai-physical-rehabilitation/what-is-ai-physical-rehabilitation">AI in Physical Rehabilitation (Hub Page)</a></li>
              <li><a href="/ai-physical-rehabilitation/personalized-rehab-plans">How Does AI Create Personalized Rehab Plans?</a></li>
              <li><a href="/ai-physical-rehabilitation/benefits-ai-physical-therapy">Benefits of AI in Physical Therapy</a></li>
              <li><a href="/ai-physical-rehabilitation/success-stories-ai-rehabilitation">Success Stories of AI in Rehabilitation</a></li>
            </ul>
