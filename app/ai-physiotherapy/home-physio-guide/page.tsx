      ...
      <main className="flex-1">
        ...
        <section className="py-12">
          <div className="container mx-auto px-6 max-w-3xl prose prose-lg dark:prose-invert space-y-8">
            ...
            <p>
              Explore full <strong>AI-recommended rehab routines</strong> in the <a href="/ai-physical-rehabilitation/personalized-rehab-plans">Personalized Rehab Plans</a>.
            </p>
            ...
            <Button className="hero-button-primary mt-4">
              <a href="/ai-physical-rehabilitation/personalized-rehab-plans">Get Your Personalized Rehab Plan</a>
            </Button>
          </div>
        </section>
