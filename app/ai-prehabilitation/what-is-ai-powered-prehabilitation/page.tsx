        ...
        <section className="text-left">
          ...
          <ul className="list-disc pl-5 space-y-2 text-gray-700 dark:text-gray-300 mb-8">
            <li>
              ...
              <Link href="/ai-prehabilitation/how-does-ai-analyze-your-prehab-needs" className="text-blue-600 dark:text-blue-400 underline">
            ...
            <li>
              ...
              <Link href="/ai-prehabilitation/prehab-exercises-tailored-by-ai" className="text-blue-600 dark:text-blue-400 underline">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-8">
            ...
            <Link href="/ai-prehabilitation/how-can-ai-help-prevent-injuries" className="text-blue-600 dark:text-blue-400 underline">
              Find out how AI prevents injuries
            </Link>{" "}
            or{" "}
            <Link href="/ai-prehabilitation/is-ai-prehabilitation-effective-for-surgery-prep" className="text-blue-600 dark:text-blue-400 underline">
