            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                ...
                <div className="p-6">
                  ...
                  <a href="/ai-rehab-ai-rehab-insights/ai-physical-rehabilitation/what-is-ai-physical-rehabilitation" className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 font-medium">Read Guide →</a>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                ...
                <div className="p-6">
                  ...
                  <a href="/ai-rehab-ai-rehab-insights/ai-prehabilitation/how-can-ai-help-prevent-injuries" className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 font-medium">Read Guide →</a>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                ...
                <div className="p-6">
                  ...
                  <a href="/ai-rehab-ai-rehab-insights/ai-personal-training/how-does-ai-track-progress-in-training" className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 font-medium">Read Guide →</a>
                </div>
              </div>
            </div>
          </div>
