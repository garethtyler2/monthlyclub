        ...
        <section className="text-left">
          ...
          <ul className="list-disc pl-5 space-y-3 text-gray-700 dark:text-gray-300 mb-8">
            ...
            <li>
              ...
              <a href="/ai-rehab-insights/ai-prehabilitation/what-is-ai-powered-prehabilitation" className="text-blue-600 dark:text-blue-400 underline">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-8">
            ...
            <a href="/ai-rehab-insights/ai-prehabilitation/is-ai-effective-for-surgery-prep" className="text-blue-600 dark:text-blue-400 underline">
