              ...
              <Card className="hover:shadow-md transition-shadow">
                <CardContent className="p-6">
                  ...
                  <Button variant="secondary" className="p-0 h-auto">
                    <a href="/ai-rehab-insights/ai-personal-training/what-is-ai-powered-personal-training" className="flex items-center">Read more <ArrowRight className="ml-1 h-4 w-4" /></a>
                  </Button>
                </CardContent>
              </Card>
              <Card className="hover:shadow-md transition-shadow">
                <CardContent className="p-6">
                  ...
                  <Button variant="secondary" className="p-0 h-auto">
                    <a href="/ai-rehab-insights/ai-personal-training/how-can-ai-help-optimize-training-results" className="flex items-center">Read more <ArrowRight className="ml-1 h-4 w-4" /></a>
                  </Button>
                </CardContent>
              </Card>
              <Card className="hover:shadow-md transition-shadow">
                <CardContent className="p-6">
                  ...
                  <Button variant="secondary" className="p-0 h-auto">
                    <a href="/ai-rehab-insights/ai-personal-training/is-ai-effective-for-specific-fitness-goals" className="flex items-center">Read more <ArrowRight className="ml-1 h-4 w-4" /></a>
                  </Button>
                </CardContent>
              </Card>
            </div>
